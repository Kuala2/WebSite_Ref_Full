...
const CONTACT_FAQS = [
  {
    ...
    answer: "Если ваши планы изменились, пожалуйста, предупредите нас об отмене или переносе визита не менее чем за 24 часа. Вы можете сделать это по телефону 8 (831) 283-54-12, написав нам в ВКонтакте, или самостоятельно через ссылку в СМС-подтверждении вашей записи. Предоплата (если она была внесена) сохраняется.",
  },
  {
