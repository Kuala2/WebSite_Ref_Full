          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-32 items-center">
            ...
            <div className="space-y-16">
              ...
              <div>
                ...
                <p className="text-lg text-brand-cream font-normal leading-relaxed">
                  В окрашивании мы используем только качественные профессиональные материалы Lebel и Keune. Мы принципиально не экономим на материалах, ведь от них зависит здоровье волос, блеск и стойкость оттенка.
                </p>
              </div>
            </div>
          </div>
