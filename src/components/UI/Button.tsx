...
export default function Button({
  ...
  const baseStyles =
    "inline-flex items-center justify-center px-[48px] py-[18px] text-xs md:text-sm font-bold uppercase tracking-[0.12em] transition-all duration-300 focus:outline-none cursor-pointer rounded-sm shadow-sm hover:shadow-md transform hover:-translate-y-1 active:translate-y-0";
